...
export const Avatar: React.FC<AvatarProps> = ({ 
  ...
  return (
    ...
    >
      <div className="absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-accent-teal/50 to-purple-500/50 blur opacity-75" />
      <div className={`relative rounded-2xl ${sizeClasses[size]} overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900`}>
